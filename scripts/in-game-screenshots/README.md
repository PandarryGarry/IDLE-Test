...
Каноническая установка браузера и прогоны дороги/auth теперь в
[`scripts/qa/README.md`](../qa/README.md) (`setup-browser.mjs`, `road.mjs`, `auth.mjs`).
Эта папка — узкий скрипт снимков эмблемы.
