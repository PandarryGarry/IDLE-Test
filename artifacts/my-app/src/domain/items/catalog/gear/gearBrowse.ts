...
export function itemMatchesGearBrowse(item: Item, f: GearBrowseFilters): boolean {
  ...
  // Тир уника виден в бейдже, но тировый фильтр его не ловит: уники отбираются
  // только переключателем «Уникальное».
 ...
 * звездой-эмблемой (тир при этом виден, как у всех).
 */
