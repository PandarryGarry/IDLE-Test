...
export const HERO_HELP = {
  ...
  path: 'Шесть дощечек тела: здоровье, удар диапазоном, броня, уворот, крит и удача. Удар и крит пока каркас — формулы боя ещё не закрыты. Сброс очков — в настройках персонажа, не здесь.',
} as const;
