...
export const HERO_HELP = {
  body: 'Тело — прокачка героя без вещей: раса + вложенные очки столпов + ветви. +1 очко столпа за каждый уровень после 1-го. Очко кладётся в один столп и поднимает его три числа тела. От столпа три луча: ветвь → пассивка → пассивка. Узел: 3 ранга. Следующий на луче открыт, когда предыдущий на 3/3. +1 очко узлов каждые 5 уровней (5, 10, 15…). Ранг ветви = +8 очков столпа к своему числу. Экипировка здесь не смешивается с прокачкой тела.',
  gear: 'Экип — только вклад вещей. Слева 14 слотов надетого (7 боевых + 7 украшений), центр — манекен, справа — мини-сумка на 14 ячеек. Снизу сумма бонусов надетого по 12 реальным характеристикам тела. Цифры 1–N сверху — наборы: сохранить текущее / надеть сохранённое. Тап по слоту или вещи открывает карточку. Двуручное занимает обе руки.',
  ...
  path: 'Путь — финальный лист персонажа: тело + ветви + экипировка. Сверху шесть главных чисел: HP, диапазон урона от Удара, броня, темп, уворот, удача. Крит не показывается отдельной дощечкой, пока новая боёвка не утвердит формулу. Ниже все 12 характеристик пачками столпов: тело, экип и итог.',
} as const;
