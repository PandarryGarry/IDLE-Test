...
export const HERO_HELP = {
  ...
  path: 'Сверху шесть дощечек: здоровье, удар диапазоном, броня, уворот, крит и удача. Ниже — остальные числа тела. Диапазон удара растёт вместе с Ударом. Крит пока каркас. Сброс очков — в настройках, не здесь.',
} as const;
