...
export const HERO_HELP = {
  ...
  path: 'Сверху шесть дощечек: здоровье, удар диапазоном, броня, уворот, крит и удача. Ниже — остальные числа тела, пачками столпов. Диапазон удара растёт вместе с Ударом. Крит пока каркас. Ник, аватар и сброс очков — в настройках героя, не в общих.',
} as const;
