...
export const FORAGING_ZONES: ForagingZone[] = [
  {
    ...
    lootTable: [
      ...
      { itemId: 'rope_fiber', weight: 4, quantity: [1, 2] },
      { itemId: 'cord_sinew', weight: 2, quantity: [1, 1] },
    ],
    rareTable: [],
    danger: {
      enemyChance: 1,
  ...
  },
  {
    ...
    lootTable: [
      ...
      { itemId: 'rope_fiber', weight: 8, quantity: [1, 2] },
      { itemId: 'cord_sinew', weight: 6, quantity: [1, 2] },
      { itemId: 'stick_03', weight: 8, quantity: [1, 2] },
      { itemId: 'stick_04', weight: 8, quantity: [1, 2] },
    ],
    rareTable: [
    ...
    previewItemIds: ['mushroom_02_raw', 'wild_berries', 'healing_herbs', 'cord_sinew'],
  },
  {
    id: 'cave',
    name: 'Пещера',
    ...
    lootTable: [
      ...
      { itemId: 'cord_sinew', weight: 10, quantity: [1, 2] },
      { itemId: 'rope_fiber', weight: 8, quantity: [1, 2] },
      { itemId: 'stick_03', weight: 8, quantity: [1, 3] },
  ...
  },
  {
    ...
    lootTable: [
      ...
      { itemId: 'mushroom_09_raw', weight: 6, quantity: [1, 1] },
      { itemId: 'cord_sinew', weight: 8, quantity: [1, 3] },
      { itemId: 'stick_02', weight: 8, quantity: [1, 3] },
  ...
  },
  {
    ...
    lootTable: [
      ...
      { itemId: 'healing_herbs', weight: 10, quantity: [1, 3] },
      { itemId: 'cord_sinew', weight: 10, quantity: [1, 3] },
      { itemId: 'rope_fiber', weight: 8, quantity: [1, 3] },
    ],
    rareTable: [
