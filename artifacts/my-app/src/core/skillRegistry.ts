import type { SkillId, WoodcuttingTree, MiningRock, FishingSpot, CookingRecipe, SmithingRecipe, FiremakingLog } from '../data/types.ts';
import { WOODCUTTING_TREES_MAP } from '../domain/professions/woodcutting.ts';
import { MINING_ROCKS_MAP, GEM_DROPS } from '../domain/professions/mining.ts';
import { FISHING_SPOTS_MAP } from '../domain/professions/fishing.ts';
...
import { chance, randomRange } from '../lib/utils.ts';
