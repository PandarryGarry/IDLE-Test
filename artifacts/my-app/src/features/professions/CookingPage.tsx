...
import { COOKING_RECIPES, COOKING_RECIPES_MAP } from '@/domain/professions/cooking';
import { useGameStore } from '@/store/gameStore';
import { useBankStore } from '@/store/bankStore';
import { ItemIcon } from '@/features/bank/ItemIcon';
import { usePlayerStore } from '@/store/playerStore';
import { calcBurnChance } from '@/core/formulas';
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-[var(--text-secondary)] text-xs font-mono flex flex-wrap items-center gap-x-3 gap-y-0.5 mt-0.5">
