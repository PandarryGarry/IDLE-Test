      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          <button onClick={onOpenMobileMenu} className="md:hidden"
            style={{ ...btn, padding: '6px 8px' }} aria-label="Меню">
            <Menu size={16} />
          </button>
          ...
          <Link href="/" style={{ display: 'flex', alignItems: 'center', gap: 8, textDecoration: 'none' }}>
            ...
            <span className="hidden md:inline" style={{
              ...
              fontSize: 16, color: '#f5d880', letterSpacing: '0.06em',
            }}>
              Aethelia<span style={{ color: '#c8880a', fontSize: 12, fontFamily: 'var(--app-font-sans)' }}>RPG</span>
            </span>
          </Link>
