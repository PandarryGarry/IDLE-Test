...
export interface Item {
   ...
   * семьи бижутерии). Тир у неё виден игроку как обычно, а уникальность
   * показывает звезда-эмблема и свечение ячейки; в фасовке она идёт
   * отдельной категорией «Уникальное», отсортированной по типу.
   */
  gearUnique?: boolean;
}
