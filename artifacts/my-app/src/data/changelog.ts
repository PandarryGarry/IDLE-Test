...
export const CHANGELOG: VersionEntry[] = [
  {
    version: '0.3.0',
    date: '2026-09-12',
    title: 'Тактические вылазки',
    changes: [
      { type: 'new', text: 'Бой стал тактической вылазкой: авто-схватка, ручные приёмы, выбор цели и шкала действий' },
      { type: 'new', text: 'Монстры получили роли, портреты, описания, способности и читаемые телеграфы атак' },
      { type: 'new', text: 'Добавлены стаи врагов и босс-фазы с окнами реакции' },
      { type: 'improve', text: 'Перед стартом зоны показывается прогноз риска и безопасного idle-времени' },
      { type: 'improve', text: 'После остановки боя появляется отчёт: что произошло, почему и какая добыча получена' },
    ],
  },
  {
    version: '0.2.0',
    ...
    title: 'Первый шаг',
    changes: [
      { type: 'new', text: 'Создайте героя: выберите расу, облик и имя для приключений в Этелии' },
      { type: 'new', text: 'Продолжайте путь выбранным героем, а прогресс бережно сохраняется между сессиями' },
      { type: 'improve', text: 'Начало приключения стало цельной историей: вход в таверну, ложа и дорога в город' },
    ],
  },
  {
    version: '0.1.0',
