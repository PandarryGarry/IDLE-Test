...
export const EQUIP_SLOT_ICON: Record<EquipSlot, string> = {
  ...
  gloves: iconUrl('armor/plate/t01/gloves'),
  weapon: iconUrl('ui/equipment_slots/slot_equip_weapon'),
  shield: iconUrl('ui/equipment_slots/slot_equip_shield'),
  amulet: iconUrl('jewelry/necklaces/v01'),
  ring: iconUrl('jewelry/rings_l/v01'),
  ring2: iconUrl('jewelry/rings_r/v01'),
  bracelet: iconUrl('jewelry/bracelets_l/v01'),
  bracelet2: iconUrl('jewelry/bracelets_r/v01'),
  belt: iconUrl('jewelry/belts/v01'),
  cape: iconUrl('ui/equipment_slots/slot_equip_chest'),
  quiver: iconUrl('skills/skill_arrow_shot'),
  passive: iconUrl('jewelry/necklaces/v02'),
};
