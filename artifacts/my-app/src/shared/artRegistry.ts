 ...
 *
 * Арты прологa (континент/тракт) греет руна-карточка первого запуска;
 * здесь нужен только город — он используется и финальным битом выхода.
 */
export const ONBOARDING_ART_PRELOAD: readonly string[] = [
  ...
  '/assets/art/prologue_city_gates.webp',
];
