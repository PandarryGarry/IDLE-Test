...
**Завершены: Этапы 1–4. PR #6 смёржен в `main`: он включает функциональный Stage 4 из PR #5 и цельный cinematic onboarding. Owner live QA в Replit остаётся обязательным; Stage 5 пока только спроектирован.**
