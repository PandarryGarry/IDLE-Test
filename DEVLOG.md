...
**Завершены: Этапы 1–4 (PR #6 в `main`). Открыт PR #7 — полная кинематографическая дорога первого запуска (акты 0–7) + фиксы iOS + план адаптива. Мерж — ТОЛЬКО после owner live QA всей дороги в Replit и только как последнее действие чата. Stage 5 спроектирован, код не начат.**
...
**Осталось до мержа PR #7:** owner live QA всей дороги в Replit (первый запуск +
повторный визит) → мерж как ПОСЛЕДНЕЕ действие чата → обновление DEVLOG/ROADMAP/handoff
уже включены в PR.
