...
**Этапы 1–4 + дорога 0–7 + слой 1 + PR #9 в `main`. Сверх того — в ветке
`arena/01a06167-idle-test` (PR #11): хотфикс создания героя,
5A (Четыре Столпа), 5B (хаб героя, доска тела, паутина пассивок) и
арт — 30 манекенов по аватарам. Дорога в Replit проверена владельцем —
ок. Ждём фидбек по экрану «Герой → Тело».**

**Манекены (арт 5B):** люди утверждены и лежат в ассетах; эльфы, гномы,
орки и зверолюди собраны и ждут вердикта владельца по листам. Рост у
всех рас одинаковый, комплекция различна: люди 22514, эльфы +2%,
