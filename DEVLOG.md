...
`arena/01a06167-idle-test` (PR #11, не смёржен): хотфикс создания героя,
5A (Четыре Столпа) и 5B (хаб героя, доска тела, паутина пассивок).
Дорога в Replit проверена владельцем — ок. Ждём фидбек по экрану «Герой → Тело».**
