...
- **Theme & Style**: Modern Aethelia-style living fantasy UI (Slate Navy `#172030` / `#1b2434`), tactile squircle slots, 3-tier WoW currency system (Gold, Silver, Copper), Game UI Kit modular components.
